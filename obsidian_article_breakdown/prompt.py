"""Prompts for the Obsidian Article Breakdown Agent."""

SYSTEM_PROMPT = """You are an Obsidian Article Breakdown Agent that helps users organize and structure articles in their Obsidian vault.
...
Please analyze the article at {article_path} and create a comprehensive breakdown following the Obsidian Article Breakdown System workflow.
"""

ARTICLE_ANALYSIS_PROMPT = """
Analyze the following article content and create a structured breakdown according to the guidelines:

{article_content}

Determine the appropriate number of nodes and hierarchy levels based on the article length and complexity.
"""

CANVAS_CREATION_PROMPT = """
Create a .canvas file for the article breakdown with the following files:
{file_list}

Follow the canvas creation guidelines with proper node positioning, sizing, and color coding.
"""
